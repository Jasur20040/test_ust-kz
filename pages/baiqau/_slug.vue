    ...
    <section class="other">
        ...
        <div class="cst-ct">
            <div class="wrapper-side">
                ...
                <div class="content">
                    <header_kroshki :header="header" gotoUrl="/baiqau" />
                    <div class="dengei_block">
                        ...
                        <div class="turnir grid-3 gap-20">
                            <div class="item d-f">
                                ...
                                <div>
                                    <div class="name">Байқау атауы:</div>
                            ...
                            <div class="item d-f">
                                ...
                                <div>
                                    ...
                                    <div class="name">Әр қатысушыдан 42тг сіздің бонустық шотыңызға аударылады, сол арқылы келесі Байқауға жеңілдікпен қатыса аласыз.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div v-else class="block">
                                ...
                                <div v-if="o_user.bari_tapsirdy" class="foot d-f a-c j-b">
                                    <div class="d-f a-c gap-10">
                                        ...
                                        <nuxt-link :to="'/baiqau/test/'+o_user.idd+'/result'">
...
<!--                                        <turnirLanding @videoOpen="videoOpen = 1" :turnirs="myTurnirs" :thisYear="thisYear" />-->
                   <olimpiadaLanding v-if="!startDate" @videoOpen="videoOpen = 1" :olimps="myOlimps" :thisYear="thisYear" baiqau="1" />
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    export default {
        ...
        async asyncData({
            ...
            let id = title[1]
            let data = await $axios.$get(`baiqau/${id}${seed}`)
            let classes = []
        ...
        methods: {
            ...
            getCertificate(id) {
                this.$api.get('/baiqau/' + id + '/certificate', {
                    responseType: 'blob'
                }).then((response) => {
            ...
            getAlgys(e, index) {
                ...
                this.$api.get('/baiqau/' + id + '/thankLetter', {
                    responseType: 'blob',
                    params: {
                        type: e
                    }
            ...
            editUser(index) {
                ...
                if(this.validator(index)) {
                    ...
                    this.$api.post('/baiqau/user/update', {
            ...
            deleteUser(index) {
                ...
                console.log(user)
                this.$api.get('/baiqau/user/' + user.idd + '/destroy').then((res) => {
                    if (res.data.success == true) {
            ...
            olimpTolem(index) {
                ...
                this.$api.post('/baiqau/test/tolem-zhasau', {
                    id: this.o_users[index].idd,
                    nomer: index + 1,
            ...
            saveNewUser() {
                if(this.validator()) {
                    this.loading = 1;
                    this.$api.post('/baiqau/user/create', {
            ...
            getMyOlimps() {
                this.$api.$get('/baiqau/baiqaularym/active', {
                    params: {
                        limit: 3,
