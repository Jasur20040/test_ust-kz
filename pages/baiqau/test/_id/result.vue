    ...
    <div>
        <div class="result d-f aj-c">
            <div class="modal_block">
                <div class="head">
                    <header_kroshki :header="header" :gotoUrl="'/baiqau/'+o_katysushy.o_bagyt.lat_name+'-'+o_katysushy.o_bagyt.idd" />
                </div>
                <div class="body">
                    <div class="green">Байқау нәтижесіне сай, Сіз <span class="uppercase">{{marapat(o_katysushy.o_tizim.result)}}</span> жеңіп алдыңыз</div>
                    <div class="list">
                        <div class="list_item">
                        ...
                        <div class="list_item">
                            ...
                            <span class="light">Байқау атауы: <b>{{o_katysushy.o_tury.o_tury}}</b></span>
                        </div>
                        <div class="list_item">
                    ...
                    <div class="d-f j-b f-wrap gap-20">
                        ...
                        <nuxt-link :to="'/baiqau/'+o_katysushy.o_bagyt.lat_name+'-'+o_katysushy.o_bagyt.idd" class="cst_size_btn">
...
<script>
    ...
    export default {
        ...
        async asyncData({
            ...
            if (!params.id) redirect('/baiqau')
            let id = params.id
            let res = await $axios.$get(`baiqau/test/${id}/load_result`)
            return {
                status: res.status,
        ...
        methods: {
            getCertificate() {
                this.$api.get('/baiqau/' + this.o_katysushy.idd + '/certificate', {
                    responseType: 'blob'
                }).then((response) => {
            ...
            katemenJumys() {
                this.$router.push({
                    name: 'baiqau-test-katemen-jumys',
                    query: {
